...
!Note: This bot will break when attempting to perform a trade and no working hiveaccount with postingkey and activekey is provided. The detectiom part should work in any case.
